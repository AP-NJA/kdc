...
def RVL_Lib(lib_name: str, objects: List[Object]) -> Dict[str, Any]:
    return {
        "lib": lib_name,
        "mw_version": "Wii/1.0",
        "cflags": cflags_rvl,
...
config.libs = [
    ...
    RVL_Lib("os", [
        ...
        # Object(NonMatching, "revolution/OS/OSSemaphore.c"),
    ...
    RVL_Lib("mtx", [
        ...
        # Object(NonMatching, "revolution/MTX/mtx44vec.c"),
    ...
    },
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "revolution/homeButtonLib/HBMAxSound.cpp"),
            Object(NonMatching, "revolution/homeButtonLib/HBMCommon.cpp"),
            ...
            Object(NonMatching, "revolution/homeButtonLib/sound/mix.cpp"),
            Object(NonMatching, "revolution/homeButtonLib/sound/syn.cpp"),
            Object(NonMatching, "revolution/homeButtonLib/sound/synctrl.cpp"),
            Object(NonMatching, "revolution/homeButtonLib/sound/synenv.cpp"),
            Object(NonMatching, "revolution/homeButtonLib/sound/synmix.cpp"),
            Object(NonMatching, "revolution/homeButtonLib/sound/synpitch.cpp"),
            Object(NonMatching, "revolution/homeButtonLib/sound/synsample.cpp"),
            Object(NonMatching, "revolution/homeButtonLib/sound/synvoice.cpp"),
            Object(NonMatching, "revolution/homeButtonLib/sound/seq.cpp"),
        ],
    },
    {
        "lib": "nrel",
        "mw_version": config.linker_version,
        "cflags": cflags_base,
        "progress_category": "middle",
        "objects": [
            Object(NonMatching, "nrel/devkit/alert/Alert.cpp"),
            Object(NonMatching, "nrel/devkit/alert/AlertStyle.cpp"),
            Object(NonMatching, "nrel/devkit/heapmap/ExpHeapMapUser.cpp"),
            Object(NonMatching, "nrel/devkit/heapmap/HeapMap.cpp"),
            Object(NonMatching, "nrel/devkit/heapmap/HeapMapBlockDrawer.cpp"),
            Object(NonMatching, "nrel/devkit/menu/base/CoreHolder.cpp"),
            Object(NonMatching, "nrel/devkit/menu/base/StringStyle.cpp"),
            Object(NonMatching, "nrel/devkit/textwriter/TextWriter.cpp"),
            Object(NonMatching, "nrel/ezrender/GXSettingFor2D.cpp"),
            Object(NonMatching, "nrel/ezrender/OrthoCameraSetting.cpp"),
            Object(NonMatching, "nrel/ezrender/Render2D.cpp"),
            Object(NonMatching, "nrel/ezrender/ViewportSetting.cpp"),
            Object(NonMatching, "nrel/mem/Block.cpp"),
            Object(NonMatching, "nrel/mem/ExpHeapAccessor.cpp"),
            Object(NonMatching, "nrel/mem/ExpHeapSupport.cpp"),
        ],
    },
    {
        "lib": "libMobiclip",
        ...
        "progress_category": "middle",
        "objects": [
            Object(NonMatching, "libMobiclip/Bignum.cpp"),
            Object(NonMatching, "libMobiclip/CodecFast.cpp"),
            Object(NonMatching, "libMobiclip/Digits.cpp"),
            Object(NonMatching, "libMobiclip/ImaAdpcm.cpp"),
            Object(NonMatching, "libMobiclip/MoApi.cpp"),
            Object(NonMatching, "libMobiclip/MoDeblockWii.cpp"),
            Object(NonMatching, "libMobiclip/MoSdk.cpp"),
            Object(NonMatching, "libMobiclip/MoSdkAdpcmDecoder.cpp"),
            Object(NonMatching, "libMobiclip/MoSdkAudioDecoder.cpp"),
            Object(NonMatching, "libMobiclip/MoSdkDemux.cpp"),
            Object(NonMatching, "libMobiclip/MoSdkFastAudioDecoder.cpp"),
            Object(NonMatching, "libMobiclip/MoSdkHeaders.cpp"),
            Object(NonMatching, "libMobiclip/MoSdkInput.cpp"),
            Object(NonMatching, "libMobiclip/MoSdkMem.cpp"),
            Object(NonMatching, "libMobiclip/MoSdkPcmPassthroughDecoder.cpp"),
            Object(NonMatching, "libMobiclip/MoSdkProcessImage.cpp"),
            Object(NonMatching, "libMobiclip/MoSdkSeek.cpp"),
            Object(NonMatching, "libMobiclip/MoSdkVideoDecoder.cpp"),
            Object(NonMatching, "libMobiclip/VX2_BitStream.cpp"),
            Object(NonMatching, "libMobiclip/VX2_Cpu.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeBlock16x16.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeBlock16x2.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeBlock16x4.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeBlock16x8.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeBlock2x16.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeBlock2x2.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeBlock2x4.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeBlock2x8.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeBlock4x16.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeBlock4x2.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeBlock4x4.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeBlock4x8.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeBlock8x16.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeBlock8x2.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeBlock8x4.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeBlock8x8.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecodeIntra.cpp"),
            Object(NonMatching, "libMobiclip/VX2_Decoder.cpp"),
            Object(NonMatching, "libMobiclip/VX2_DecoderMeFct.cpp"),
            Object(NonMatching, "libMobiclip/VX2_InvMc.cpp"),
            Object(NonMatching, "libMobiclip/VX2_InverseQuantization.cpp"),
            Object(NonMatching, "libMobiclip/VX2_MotionCompensation.cpp"),
            Object(NonMatching, "libMobiclip/VX2_Pred.cpp"),
        ],
    },
    {
        "lib": "libms",
        ...
        "objects": [
            ...
            Object(NonMatching, "libms/commonbin.c"),
            Object(NonMatching, "libms/projfile.c"),
        ],
    },
    {
        "lib": "donut",
    ...
    },
    {
        ...
        "objects": [
            ...
            Object(Matching, "donut/app/Random.cpp", extra_cflags=["-O3,s"]),
    ...
    },
    {
        ...
        "objects": [
            ...
            Object(Matching, "donut/mintvm/MintSystemCall.cpp", extra_cflags=["-O3,s"]),
...
config.progress_categories = [
    ...
    ProgressCategory("middle", "Middleware Code"),
